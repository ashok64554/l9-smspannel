...
Route::namespace('App\Http\Controllers\Api\Common')->group(function () {
    ...
    Route::group(['middleware' => 'auth:api'],function () {
        ...
        Route::controller(WAConfigurationController::class)->group(function () {
            ...
            Route::get('wa-marketing-lite-api-status/{whats_app_configuration_id}', 'waMarketingLiteApiStatus')->name('wa-marketing-lite-api-status');
            Route::post('onboard-partners-to-mm-lite/{whats_app_configuration_id}', 'onboardPartnersToMMLite')->name('onboard-partners-to-mm-lite');

            //Assign account to child account
            Route::post('wa-configuration-assign-to-child', 'waConfigurationAssignToChild')->name('wa-configuration-assign-to-child');
        ...
        Route::controller(WAChatBotThreadController::class)->group(function () {
        ...
        Route::controller(WAReportController::class)->group(function () {
            ...
            Route::post('wa-chatbots-self-webhook', 'waChatbotsSelfWebhook')->name('wa-chatbots-self-webhook');
        });
...
Route::namespace('App\Http\Controllers\Api\Admin')->group(function () {
    Route::group(['prefix' => 'administration', 'middleware' => ['admin', 'auth:api']],function () {
        ...
        Route::controller(AdminActionController::class)->group(function () {
            ...
            // change role
            Route::post('change-user-role', 'changeUserRole')->name('change-user-role');

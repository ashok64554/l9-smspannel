...
Route::post('wa-webhook-session-api-record',[App\Http\Controllers\WebhookController::class, 'waWebhookSessionApiRecord'])->name('post.wa-webhook-session-api-record');

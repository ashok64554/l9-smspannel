...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('whats_app_configurations', function (Blueprint $table) {
            ...
            $table->string('marketing_messages_lite_api_status')->nullable()->comment('this is for marketing lite message api, if return ELIGIBLE then only allow to onboarding');
            $table->string('mm_lite_request_id')->nullable();
            $table->boolean('is_mm_lite_request_sent')->nullable()->default(false);
